...
import (
	"fmt"
	"git.xx.network/elixxir/xx-messenger-reports/server"
...
// serverCmd starts a server for xxmessenger reports
var serverCmd = &cobra.Command{
	Use:   "xxmessenger reports server",
	Short: "Main command for xxmessenger reports server",
	Args:  cobra.NoArgs,
